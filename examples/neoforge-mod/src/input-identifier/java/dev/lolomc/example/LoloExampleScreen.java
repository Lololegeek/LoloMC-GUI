...
final class LoloExampleScreen extends Screen {
    ...
    static LoloExampleScreen create(Minecraft client) {
        try (InputStream xml = resource(client, LoloGuiNeoForgeExample.resource("ui/screen.xml"));
             InputStream css = resource(client, LoloGuiNeoForgeExample.resource("ui/screen.css"))) {
