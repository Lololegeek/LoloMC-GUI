...
final class LoloExampleScreen extends Screen {
    ...
    private static InputStream resource(Minecraft client, net.minecraft.resources.ResourceLocation id) throws IOException {
    ...
    @Override public boolean keyPressed(int keyCode, int scanCode, int modifiers) { return host.keyPressed(keyCode) || super.keyPressed(keyCode, scanCode, modifiers); }
}
